...
public class Child extends Parent{
    ...
    // 부모 클래스 Parent 에서 상속받은 메소드 method1(), method2()가존재함.
    // method1()은 부모 클래스에서 상속받은 그대로 수정없이 사용하기 때문에 입력된 내용이 없어도 사용가능

    //부모 클래스에서 상속받은 method2()를 자식 클래스 전용으로 오버라이딩 하여 사용.
    @Override
    public void method2(){
